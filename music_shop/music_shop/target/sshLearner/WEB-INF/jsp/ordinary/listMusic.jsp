...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-2 column">
            <a class="btn btn-primary" href="">查看我的收藏(暂未实现)</a>
        </div>
        ...
        <div class="col-md-4 column">
            <form action="${path}/ordinary/searMusic" method="get" class="form-inline">
    ...
    <div class="row clearfix">
        <div class="col-md-12 column">
            <table class="table table-hover table-striped">
                ...
                <tbody>
                <c:forEach var="music" items="${requestScope.get('musiclist')}" varStatus="status">
                    <tr>

...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-2 column">
            <a class="btn btn-primary" href="${path}/login">查看我的收藏(暂未实现)</a>
        </div>
    ...
    <div class="row clearfix">
        <div class="col-md-12 column">
            <table class="table table-hover table-striped">
                ...
                <tbody>
                <c:forEach var="music" items="${requestScope.get('tourisMusicList')}" varStatus="status">
                    <tr>
                        ...
                        <td>
                            <a href="${path}/login">收藏</a> |
                            <a href="${path}/login">加入购物车</a>
                        </td>
                    </tr>
                </c:forEach>
                </tbody>

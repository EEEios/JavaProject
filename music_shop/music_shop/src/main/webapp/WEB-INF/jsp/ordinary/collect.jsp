    ...
    <div class="row clearfix">
        <div class="col-md-12 column">
            <table class="table table-hover table-striped">
                ...
                <tbody>
                <c:forEach var="music" items="${requestScope.get('collectlist')}" varStatus="status">
                    <tr>
                        ...
                        <td>
                            <a href="${path}/music/toUpdateMusic?id=${music.musicId}">收藏</a> |
                            <a href="${path}/music/del/${music.musicId}">加入购物车</a>
                        </td>
                    </tr>
                </c:forEach>
                </tbody>
